...
namespace Sistema.Presentacion
{
    public partial class FrmClientes : Form
    {
        ...
        private void Listar()
        {
            dgvlistado.DataSource = NPersona.Listar_cliente();
        ...
        private void dgvlistado_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                string tipoDocumentoTexto = dgvlistado.Rows[e.RowIndex].Cells["Tipo_Documento"].Value.ToString();
